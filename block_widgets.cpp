...
//------------------------------------------------------------------------------
FloatProperty::FloatProperty(const BlockDef::Param& param, QWidget* parent)
    : QWidget(parent)
    ...
    , _label(new QLabel())
{
  connect(_slider, &QSlider::valueChanged, this, &FloatProperty::setValue);
...
//------------------------------------------------------------------------------
ColorProperty::ColorProperty(const BlockDef::Param& param, QWidget* parent)
    : QWidget(parent), _color(param.defaultValue.value<QColor>())
{
